...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
    ...
    },{id: "news-i-awarded-erasmus-mundus-joint-master-s-degree-emjmd-scholarship-from-the-european-union-mortar-board-sparkles-partying-face",
          title: 'I awarded Erasmus Mundus Joint Master’s Degree (EMJMD) Scholarship from The European Union...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%70%68%61%6D%74%68%61%6E%68%6C%6F%63.%62%6B%68%6E@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/leopt4# your GitHub user name", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://wa.me/34627430155", "_blank");
        },
      },{
        id: 'social-youtube',
        title: 'YouTube',
        section: 'Socials',
        handler: () => {
          window.open("https://youtube.com/@Leo_Nomada", "_blank");
        },
      },{
      id: 'light-theme',
